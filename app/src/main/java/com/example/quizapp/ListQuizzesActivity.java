        ...
        if (solvedQuizzes) {
            ValueEventListener listener = new ValueEventListener() {
                ...
                public void onCancelled(@NonNull DatabaseError error) {
                    Toast.makeText(ListQuizzesActivity.this, "Can't connect", Toast.LENGTH_SHORT).show();
                }
            };
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (solvedQuizzes) {
                item.setOnClickListener(view1 -> {
                    Intent intent = new Intent(ListQuizzesActivity.this, ResultActivity.class);
                    intent.putExtra("Quiz ID", ids.get(i));
                    startActivity(intent);
                });
            } else if (createdQuizzes) {
                item.setOnClickListener(view1 -> {
                    Intent intent = new Intent(ListQuizzesActivity.this, ListQuizzesActivity.class);
